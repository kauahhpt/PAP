...
<asp:Content ID="Main" ContentPlaceHolderID="mainContent" runat="server">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
        <div>
            <h1 class="h3 mb-1">As minhas turmas</h1>
            <p class="text-muted mb-0">Turmas e disciplinas que lhe estão atribuídas.</p>
        </div>
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4">
            <div class="card stat-card">
                <div class="card-body">
                    <div class="text-muted">Turmas atribuídas</div>
                    <asp:Label ID="LblTotalTurmas" runat="server" CssClass="fs-2 fw-bold" />
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card stat-card">
                <div class="card-body">
                    ...
                    <asp:Label ID="LblTotalAlunos" runat="server" CssClass="fs-2 fw-bold" />
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card stat-card">
                <div class="card-body">
                    <div class="text-muted">Atividades futuras</div>
                    <asp:Label ID="LblTotalAtividades" runat="server" CssClass="fs-2 fw-bold" />
                </div>
            </div>
        </div>
    </div>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <a class="btn btn-primary btn-sm me-1"
                                href='turma.aspx?id=<%# Eval("TurmaId") %>'>Ver turma
                            </a>
                            <a class="btn btn-outline-primary btn-sm"
                                href='calendario.aspx?turma=<%# Eval("TurmaId") %>'>Calendário</a>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
